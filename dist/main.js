...
const parseListOfLists = (async () => {
  if (localStorage.getItem("listOfLists") !== null) {
    ...
    parsedArray.forEach((item) => {
      ...
      // domGeneration();
      showList(_list_stuff__WEBPACK_IMPORTED_MODULE_1__.listOfLists[0].items);
      showAllLists();
    });
